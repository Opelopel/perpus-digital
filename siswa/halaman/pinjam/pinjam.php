...
<table id="maintable" class="display compact cell-border" cellspacing="0" width="100%">
    ...
    <tr bgcolor="red">
        ...
        <td width="15%" align="center">Siswa</td>
        <td width="15%" align="center">Judul Buku</td>
        <td width="20%" align="center">Waktu Pinjam</td>
    ...
    ?>
        ...
        <tr>
            ...
            <td align="center">
                ...
                <button style =font-size:10 px >Edit</button>
                </a>
                |
                ...
                <button style =font-size:10 px >Delete</button>
                </a>
            </td>
        </tr>
